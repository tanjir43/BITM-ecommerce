...
<head>
    ...
    <link href="{{asset('/')}}./asset/vendors/themify-icons/css/themify-icons.css" rel="stylesheet" />
    <!-- THEME STYLES-->
    <link href="{{asset('/')}}asset/css/main.css" rel="stylesheet" />
    <!-- PAGE LEVEL STYLES-->
    <link href="{{asset('/')}}./asset/css/pages/auth-light.css" rel="stylesheet" />
</head>
...
<!-- PAGE LEVEL PLUGINS -->
<script src="{{asset('/')}}./asset/vendors/jquery-validation/dist/jquery.validate.min.js" type="text/javascript"></script>
<!-- CORE SCRIPTS-->
