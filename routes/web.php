...
//admin authenticate part start
//
//Route::get('/admin-logout',[
//    'uses' => 'App\Http\Controllers\DashboardController@adminLogout',
//    'as'   => 'admin.logout',
//     'middleware' => ['auth:sanctum','verified']
//]);

//admin authenticate part end
